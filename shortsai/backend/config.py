...
# Optional: a cookies.txt (Netscape format) exported from a logged-in browser
# session. YouTube often blocks downloads from cloud server IPs with a
# "confirm you're not a bot" error; passing cookies from your own account
# works around that for videos you own.
YOUTUBE_COOKIES_PATH = STORAGE_DIR / "youtube_cookies.txt"
